...
<nav class="navbar navbar-expand-sm bg-body-tertiary fixed-top border-bottom">
    <div class="container-fluid m-1">
        ...
        <div class="offcanvas w80 offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item d-none d-sm-block">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end ">
                            ...
                            if ($_SESSION['admin'] == 1) {
                            ?>
                                <li class="w-100 dropdown-item"><a class="nav-link<?= $filename === "view_table.php" ? ' active" aria-current="page"' : '"' ?> href='view_table.php'"><i class="bi bi-table"></i> Tabeller</a></li>
                            <?php
                            }
                            ?>
                    ...
                    <div class="nav-item d-block my-2 d-sm-none">
                        ...
                        <li class="nav-item w-100" <?= $_SESSION['admin'] == 1 ? 'style="display: block;"' : 'style="display: none;"' ?>><a class="nav-link<?= $filename === "view_table.php" ? ' active" aria-current="page"' : '"' ?> href='view_table.php'"><i class="bi bi-table"></i> Tabeller</a></li>
